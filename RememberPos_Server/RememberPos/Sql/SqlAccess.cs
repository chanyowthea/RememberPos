...
namespace RememberPos
{
	public class SqlAccess
	{
		...
		// 39.106.31.37
		public static string host = "127.0.0.1"; // 192.168.1.4
		...
		public static void OpenSql()
		{
			...
			{
				//Singleton._log.Info("服务器连接失败，请重新检查是否打开MySql服务。" + e.Message.ToString());
			}
		}
		...
		public void CreateTable(string tableName, string[] col, string[] colType, bool isAutoID = true)
		{
			...
			{
				Singleton._log.Info("columns.Length != colType.Length");
				return;
			}
